...
public final class Appointment implements Model {
  ...
  private Appointment(String id, String doctorId, String user, String doctor, String lat, String lon, String symptoms, String date, String status) {
    this.id = id;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String doctorId, String user, String doctor, String lat, String lon, String symptoms, String date, String status) {
      super.id(id);
